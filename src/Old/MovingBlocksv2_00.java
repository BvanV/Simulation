 ...
 */
public class MovingBlocksv2_00 extends JPanel implements MouseListener {
    ...
    public MovingBlocksv2_00(int width, int height) {
    ...
    public static void main(String[] args) {
        ...
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                f.setContentPane(new MovingBlocksv2_00(SCREEN_WIDTH, SCREEN_HEIGHT));
                f.pack();
                f.setVisible(true);
            }
        });
