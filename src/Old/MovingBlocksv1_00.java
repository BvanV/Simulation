 ...
 *
 */
public class MovingBlocksv1_00 extends JPanel implements MouseListener {

	/**
	 * 
	 */
	private static String TITLE = "Moving blocks v1.00";
    ...
    public MovingBlocksv1_00(int width, int height) {
