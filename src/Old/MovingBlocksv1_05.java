 ...
 * 
 */
public class MovingBlocksv1_05 extends JPanel implements MouseListener {

	/**
	 * 
	 */
	private static String TITLE = "Moving blocks v1.05";
    ...
    public MovingBlocksv1_05(int width, int height) {
    ...
    public static void main(String[] args) {
        ...
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                f.setContentPane(new MovingBlocksv1_05(SCREEN_WIDTH, SCREEN_HEIGHT));
                f.pack();
                f.setVisible(true);
            }
        });
        ...
        public Block(int index, int xsize, int ysize) {
            ...
            for(int i=0;i<ysize;i++) {
            	for(int j=0;j<xsize;j++) {
            		...
            		blokjes[i*xsize + j].x = 5 + j * 50;
            		blokjes[i*xsize + j].y = y + i * 25;
            	}
            }
        }
