 ...
 * 
 */
public class MovingBlocksv2_02 extends JPanel implements MouseListener {

	/**
	 * 
	 */
	private static String TITLE = "Moving blocks v2_02";
	...
	private static int CONTAINER_FIELD_OFFSET = SCREEN_WIDTH - CONTAINER_FIELD_WIDTH - (10 * CONTAINER_LENGTH);
    ...
    public MovingBlocksv2_02(int width, int height) {
    ...
    public static void main(String[] args) {
        ...
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                f.setContentPane(new MovingBlocksv2_02(SCREEN_WIDTH, SCREEN_HEIGHT));
                f.pack();
                f.setVisible(true);
            }
        });
...
*/
    ...
    public static class Crane extends Block {
				...
				if(!startedThisShip && !busy) {	// start with this ship
					...
					if(containerIsDone) {
						...
						if(indexCurrentContainer == -1) { // No container to handle
							...
							System.out.println("reactivate ship");
		...
		public void releaseContainer() {
			System.out.println("release container");
		...
		public int nextContainerToHandle() {
			...
			if(indexCurrentContainer != 0 && leftRow < 1) {
				System.out.println("next container is 0");
				return 0;
			} else {
				System.out.println("next container is 1");
				return -1;
			}
		}
    }
